...
from webapp2_extensions import serialize_key

from app.models.clue import Clue

class Group(ndb.Model):
    SERIALIZERS=[serialize_key]
    ...
    sms_sent = ndb.IntegerProperty(default=0)
    mms_sent = ndb.IntegerProperty(default=0)
    sms_received = ndb.IntegerProperty(default=0)
    mms_received = ndb.IntegerProperty(default=0)
